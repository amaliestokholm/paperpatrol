...
asterochronometry_tpl = __ROOT__ + '/mpia.tpl'

class asteroTemplate(ExportPDFLatexTemplate):
    """ Template used at MPIA
    which shows 2 figures and adapt the layout depending of figure aspect ratios
    """

    template = open(asterochronometry_tpl, 'r').read()
...
def main(template=None, options=None):
    """ Main function """
    ...
    for paper in keep:
        try:
            ...
            if (paper_request_test or institute_test):
                ...
                print("Not from Asterochronometry group... Skip.")
